...
module.exports = function (options) {
    ...
    var transporter = nodemailer.createTransport(
        ...
        },
        {
            ...
            // sender info
            from: 'Chess Club <' + config.get("email.adminEmail") + '>',
            // headers: {
    ...
    email.sendConfirmationEmail = function(name, confirmationToken, to, successCallback, failureCallback) {
        ...
        email.sendEmail({
            to: "<" + to + ">",
            subject: "Chess Club Confirmation",
            html: "<p>Hi " + name+ ",</p><p>Thanks for signing up to the chess club. Please confirm your email for us by clicking this <a href='" + url + "'>link</a></p>"
            + "<p>If link isn't clickable add the following to your browser url bar: " 
            + url +"</p>"
            + "<p>If you didn't signup then ignore this email.</p>"
            + "<p>e-regards</p><p>Chess Club Admin</p>"
